...
public final class SMF {
	...
	public void write(OutputStream os) 
		...
		//write all tracks
		Enumeration<Track> aEnum = trackList.elements();
		while(aEnum.hasMoreElements()){
			Track smfTrack = aEnum.nextElement();
