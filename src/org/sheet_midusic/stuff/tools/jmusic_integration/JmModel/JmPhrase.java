...
public class JmPhrase {
	...
	// TODO: instead of org.sheet_midusic.staff and channel and notaOrder better pass here already filtered sequence with pauses on place of emptyness
...
//			int channlePhraseCount = org.sheet_midusic.staff.getChordList().stream()
...
//			}
//
//			for (Chord chord: org.sheet_midusic.staff.getChordList()) {
//
