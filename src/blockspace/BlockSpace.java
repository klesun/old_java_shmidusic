...
//		this.validate();
	...
	public JSONObject getJsonRepresentation() {
		return new JSONObject()
			.put("childBlockList", new JSONArray(childScrollList.stream().map(child -> {
				JSONObject childJs = child.content.getJsonRepresentation();
				childJs.put("scroll", child.getJsonRepresentation());
